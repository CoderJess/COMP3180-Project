...
Revision ID: 2dc8a1343b08
Revises: 
Create Date: 2025-05-07 00:16:10.608188
...
def upgrade():
    ...
    sa.Column('parish', sa.String(length=20), nullable=True),
    ...
    sa.Column('fav_cuisine', sa.String(length=30), nullable=True),
    sa.Column('fav_colour', sa.String(length=15), nullable=True),
    sa.Column('fav_school_subject', sa.String(length=20), nullable=True),
